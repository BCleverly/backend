...
<div {{ $attributes->merge([
    ...
    <div class="mt-1 flex rounded-md shadow-sm">
        ...
        <input
                ...
                class="datetime flex-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full min-w-0 {{isset($prefix) === false ? 'rounded-l-md' : ''}} {{isset($suffix) === false ? 'rounded-r-md' : ''}} sm:text-sm border-gray-300">
        @isset($suffix)
